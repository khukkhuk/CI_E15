...
<div class="container">
<?php 
  echo anchor('welcome/act_show',"กิจกรรมที่ดำเนินการอยู่");
?>

<hr>
<h6>กิจกรรมที่ผ่านมา</h6>
...
foreach($show as $row){
  ?>
    <tr>
      ...
      <td colspan="2"><?php echo anchor('welcome/act_report/'.$row['act_id'],"รายละเอียด");?></td>
    </tr>
<?php
}?>
  </table>
