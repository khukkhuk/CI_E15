...
<div class="container">
<?php 
  echo anchor('welcome/act_show_complete',"กิจกรรมที่ผ่านมา");
?>
<?php 
  echo " ";
  echo anchor('welcome/act_addview',"เพิ่มกิจกรรม");
?>
<hr>
<h6>จัดการกิจกรรม</h6>
...
foreach($show as $row){
  ?>
    <tr>
      ...
      <td><?php echo anchor('welcome/act_report/'.$row['act_id'],"ดูรายชื่อ");?></td>
      <td><?php echo anchor('welcome/act_editshow/'.$row['act_id'],"แก้ไข");?></td>
      <td><?php echo anchor('welcome/act_del/'.$row['act_id'],"ลบ");?></td>
    </tr>
<?php
}?>
  </table>
